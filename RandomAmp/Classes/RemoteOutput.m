...
#define CALLBACKFUNC genSineWave
...
- (void)prepareAudioUnit{    
	...
	waveInfo.ampPhase = 0.0;
	waveInfo.ampTargetFreq = 0.05;
	waveInfo.ampCurrentUnit = 2.0 * M_PI * waveInfo.ampTargetFreq / waveInfo.sampleRate;
